<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="frmSuppLedger.aspx.cs" Inherits="DRN_WEB_ERP.Module.Accounts.Forms.frmSuppLedger" %>
                ...
                <div align="center" style="background-color: #86AEAE">
                    ...
                    <span>Search GL Code:</span> <span>
                        ...
                        <cc1:AutoCompleteExtender ID="AutoCompleteExtenderSrch" runat="server" BehaviorID="AutoCompleteSrch"
                            ...
                            DelimiterCharacters="," MinimumPrefixLength="1" ServiceMethod="GetSrchCoaByType"
                        ...
                        <asp:Button ID="btnSearch" runat="server" onkeypress="return clickButton(event,'btnSearch')"
                            Text="View" ValidationGroup="btnSearch" OnClick="btnSearch_Click" Width="60px" />
                        ...
                        <asp:Button ID="btnSearchAll" runat="server" OnClick="btnSearchAll_Click" onkeypress="return clickButton(event,'btnSearch')"
                            Text="Print All" ValidationGroup="btnSearch" />
