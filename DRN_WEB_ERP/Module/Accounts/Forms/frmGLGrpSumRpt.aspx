<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="frmGLGrpSumRpt.aspx.cs" Inherits="DRN_WEB_ERP.Module.Accounts.Forms.frmGLGrpSumRpt" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div align="center" style="background-color: #00FF99">
        GL Group Statement</div>
            ...
            <div align="center">
                <table style="width: 100%; font-size: 12px; background-color: #CCFFFF;">
                    ...
                    <tr>
                        ...
                        <td style="width: 136px">
                            <asp:DropDownList ID="cboGLGroup" runat="server" Width="250px">
                                <asp:ListItem Value="P">Customer</asp:ListItem>
