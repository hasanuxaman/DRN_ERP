...
{
    public partial class frmPaymentEdit : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (custCode.Length > 0)
                {
                    ...
                    {
                        var taFaTe = new View_Acc_Pay_JvTableAdapter();
                        var dtFaTe = taFaTe.GetDataByPayDateRangeAccCode(dtGlCoa[0].Gl_Coa_Code.ToString(), txtFrmDate.Text.Trim(), txtToDate.Text.Trim());
