...
{
    public partial class frmOpnBalEdit : System.Web.UI.Page
    {
        decimal totDrAmt = 0;
        decimal totCrAmt = 0;
                                    ...
                                    if (dtFaTe[0].Trn_Trn_type == "C")
                                    {
                                        ...
                                        if (CrBal > 0)
                                        {
                                            if ((CrBal - TranDrAmt) < 0)
                                                taCrReal.InsertCreditRealize(txtTranRefNo.Text + "_" + lblSlNo.ToString(), txtTranRefNo.Text, Convert.ToDateTime(txtTranDate.Text.Trim()),
