<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="frmVoucherEntry.aspx.cs" Inherits="DRN_WEB_ERP.Module.Accounts.Forms.frmVoucherEntry" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div align="center" style="background-color: #00FF99">
        Journal Voucher Entry</div>
                                    ...
                                    <tr valign="top">
                                        ...
                                        <td align="left" class="style3" style="width: 165px">
                                            <asp:TextBox ID="txtTranDate" runat="server" CssClass="textAlignCenter" ForeColor="Blue"
                                                Width="120px" AutoPostBack="True" OnTextChanged="txtTranDate_TextChanged"></asp:TextBox>
                                            ...
                                            <cc1:CalendarExtender ID="CalenderValDt" runat="server" Enabled="True" Format="dd/MM/yyyy"
                                                PopupButtonID="imgRcvDt" TargetControlID="txtTranDate">
                                        ...
                                        <td align="center" class="style5" rowspan="4" style="font-size: 14px; width: 158px;">
                                            <asp:Button ID="btnAdd" runat="server" CssClass="btn" Height="60px" OnClick="btnAdd_Click"
                                    ...
                                    <tr valign="top">
                                        ...
                                        <td align="left" class="style3" style="width: 165px">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="txtTranDate"
                                                ErrorMessage="RequiredFieldValidator" Font-Size="8pt" ForeColor="Red" ValidationGroup="btnAdd">Enter Date</asp:RequiredFieldValidator>
                                            <asp:CustomValidator ID="CustomValidator2" runat="server" ControlToValidate="txtTranDate"
                                                ...
                                                ValidationGroup="btnAdd">Invalid Date</asp:CustomValidator>
                                        </td>
                                        <td align="right" class="style4" style="font-size: 12px; width: 89px;">
                                            &nbsp;
                                        </td>
                                    ...
                                    <tr valign="top">
                                        ...
                                        <td align="left" class="style1" colspan="4">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="txtGlAcc"
                                                ErrorMessage="RequiredFieldValidator" Font-Size="8pt" ForeColor="Red" ValidationGroup="btnAdd">Enter GL Account</asp:RequiredFieldValidator>
                                            <asp:CustomValidator ID="CustomValidator1" runat="server" ControlToValidate="txtGlAcc"
                                                ErrorMessage="CustomValidator" Font-Size="8pt" ForeColor="Red" OnServerValidate="CustomValidator1_ServerValidate"
                                                ValidationGroup="btnAdd">Invalid GL Account</asp:CustomValidator>
                                        </td>
                                        <td align="right" class="style4" style="font-size: 12px; width: 89px;">
                                            &nbsp;
                                        </td>
                                        ...
                                        <td align="left" class="style4" style="font-size: 12px; width: 74px;">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="txtTranAmt"
                                                ErrorMessage="RequiredFieldValidator" Font-Size="8pt" ForeColor="Red" ValidationGroup="btnAdd">Enter Amount</asp:RequiredFieldValidator>
                                            <br />
