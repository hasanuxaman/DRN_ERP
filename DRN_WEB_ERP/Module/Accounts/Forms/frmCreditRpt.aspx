<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="frmCreditRpt.aspx.cs" Inherits="DRN_WEB_ERP.Module.Accounts.Forms.frmCreditRpt" %>
    ...
    <div align="center">
        <table style="width: 100%; font-size: 12px; background-color: #CCFFFF;">
            ...
            <tr>
                ...
                <td style="width: 98px">
                    <asp:Button ID="btnShowCollectRpt" runat="server" Text="Show" ValidationGroup="btnShow"
                        Width="100px" OnClick="btnShowCollectRpt_Click" />
                </td>
                <td style="width: 98px">
                    &nbsp;
                </td>
