<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="frmTranPayRcv_Old.aspx.cs" Inherits="DRN_WEB_ERP.Module.Accounts.Forms.frmTranPayRcv_Old" %>
        ...
        <ContentTemplate>
            <asp:Panel ID="pnlSearchBox" runat="server" DefaultButton="btnSearch">
                <div align="center" style="background-color: #86AEAE">
                    <br />
                    <span>Search Saved Voucher No:</span>
                                ...
                                <tr>
                                    ...
                                    <td align="right" style="width: 207px">
                                        <asp:RadioButtonList ID="optJvType" runat="server" RepeatDirection="Horizontal" AutoPostBack="True"
                                            OnSelectedIndexChanged="optJvType_SelectedIndexChanged">
                                            <asp:ListItem Value="1" Selected="True">Expences</asp:ListItem>
                                            <asp:ListItem Value="2">Income</asp:ListItem>
                                        </asp:RadioButtonList>
                                    </td>
                                    <td align="left" style="width: 562px">
                                        <asp:TextBox ID="txtHdrGlAcc" runat="server" CssClass="search textAlignCenter" Width="550px"
                        ...
                        <div align="center" style="background-color: #9999FF">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; font-size: 12px;">
                                ...
                                <tr valign="top">
                                    ...
                                    <td align="left" class="style4" style="font-size: 12px; width: 171px;">
                                        <asp:DropDownList ID="ddlTranType" runat="server" Width="130px" Enabled="False">
