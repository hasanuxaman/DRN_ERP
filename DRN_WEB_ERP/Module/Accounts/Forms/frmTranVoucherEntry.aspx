<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="frmTranVoucherEntry.aspx.cs" Inherits="DRN_WEB_ERP.Module.Accounts.Forms.frmTranVoucherEntry" %>
        ...
        <ContentTemplate>
            <asp:Panel ID="pnlSearchBox" runat="server" DefaultButton="btnSearch">
                <div align="center" style="background-color: #86AEAE">
                    <br />
                    <span>Search Existing Voucher No:</span> <span>
