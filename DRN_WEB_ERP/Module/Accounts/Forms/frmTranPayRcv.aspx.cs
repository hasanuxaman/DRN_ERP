...
{
    public partial class frmTranPayRcv : System.Web.UI.Page
    {
        decimal totDrAmt = 0;
        decimal totCrAmt = 0;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            optJvType.Attributes.Add("style", "background-color:transparent");            

            var jvPrefix = optJvType.SelectedValue == "1" ? "TCPV" : "TCRV";

            txtTranDate.Text = DateTime.Now.ToString("dd/MM/yyyy");

            var taAccJvHold = new tbl_Acc_Jv_HoldTableAdapter();
            var dtNewMaxAccRef = taAccJvHold.GetMaxRef(jvPrefix);
            var nextNewAccRef = dtNewMaxAccRef == null ? "000001" : (Convert.ToInt32(dtNewMaxAccRef) + 1).ToString();
            var nextNewAccRefNo = "TMP-" + jvPrefix + (DateTime.Now.Month.ToString("00") + DateTime.Now.ToString("yy")).ToString() + "-" + Convert.ToInt32(nextNewAccRef).ToString("000000");
            ...
            optJvType.SelectedItem.Attributes.Add("style", "background-color:red");
                ...
                if (txtSearch.Text.Trim().Length > 0)
                {
                    ...
                    if (dtJvDet.Rows.Count > 0)
                    {
                        ...
                        {                            
                            ...
                            optJvType.SelectedValue = Flag == "TCPV" ? "1" : "2";
                            optJvType.SelectedItem.Attributes.Add("style", "background-color:red");
        ...
        protected void btnClearSrch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //var dtNewMaxAccRef = taAcc.GetMaxRefNo("TCPV", Convert.ToDateTime(txtTranDate.Text.Trim()).Year);
                //var nextNewAccRef = dtNewMaxAccRef == null ? "000001" : (Convert.ToInt32(dtNewMaxAccRef) + 1).ToString();
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                dt.Rows.Add(COA_CODE, COA_NAME, txtTranDate.Text.Trim(), TRAN_NARRATION, TRAN_DEBIT.ToString("N2"), TRAN_CREDIT.ToString("N2"), jvPrefix);
        ...
        protected void btnHold_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    var dtMaxJvRef = taAccJvHold.GetMaxRef(jvPrefix);
                    var nextJvRef = dtMaxJvRef == null ? "000001" : (Convert.ToInt32(dtMaxJvRef) + 1).ToString();
                    nextJvRefNo = "TMP-" + jvPrefix + (DateTime.Now.Month.ToString("00") + DateTime.Now.ToString("yy")).ToString() + "-" + Convert.ToInt32(nextJvRef).ToString("000000");
                }
                ...
                {                    
                    ...
                    taAccJvHold.InsertAccJvHold(coaCode.ToString(), coaName.ToString(), nextJvRefNo.ToString(), Convert.ToDateTime(txtTranDate.Text.Trim()), jvLno,
                        ...
                        hdrPartyName.ToString(), cboTruckNo.SelectedItem.ToString(), "", "", "H", "1", jvPrefix);
                ...
                var dtNewMaxJvRef = taAccJvHold.GetMaxRef(jvPrefix);
                var nextNewJvRef = dtNewMaxJvRef == null ? "000001" : (Convert.ToInt32(dtNewMaxJvRef) + 1).ToString();
                txtTranRefNo.Text = "TMP-" + jvPrefix + (DateTime.Now.Month.ToString("00") + DateTime.Now.ToString("yy")).ToString() + "-" + Convert.ToInt32(nextNewJvRef).ToString("000000");
            }
            catch (Exception ex)
            {
                myTran.Rollback();
        ...
        protected void btnPost_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                foreach (GridViewRow row in gvVoucherDet.Rows)
                {
                    ...
                    taAccJvHold.InsertAccJvHold(coaCode.ToString(), coaName.ToString(), nextJvRefNo.ToString(), Convert.ToDateTime(txtTranDate.Text.Trim()), jvLno,
                        TRAN_NARRATION.ToString(), TRAN_TYPE, Convert.ToDecimal(TRAN_AMT), hdrPartyCode, cboTruckNo.SelectedValue.ToString(), txtKm.Text.ToString(),
                        hdrPartyName.ToString(), cboTruckNo.SelectedItem.ToString(), "", "", "P", "1", jvPrefix);
        ...
        protected void optJvType_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //optJvType.SelectedItem.Attributes["style"] = "background-color:red;";
