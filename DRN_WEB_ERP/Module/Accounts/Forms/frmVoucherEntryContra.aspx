<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="frmVoucherEntryContra.aspx.cs" Inherits="DRN_WEB_ERP.Module.Accounts.Forms.frmVoucherEntryContra" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div align="center" style="background-color: #00FF99">
        Contra Voucher Entry</div>
    <asp:UpdatePanel ID="updpnl" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:Panel ID="pnlSearchBox" runat="server" DefaultButton="btnSearch">
                <div align="center" style="background-color: #86AEAE">
                    <br />
                    <span>Debit Acc:</span> <span>
    ...
    <asp:Panel ID="pnlDet" runat="server" Enabled="false">
        <div align="center" style="background-color: #9999FF">
                ...
                <tr>
                    ...
                    <td align="center" style="width: 33px">
                        ...
                        <asp:Label ID="lblCrLimitOutStand" runat="server" BorderStyle="None" ForeColor="White"
                            Text="0.00" Visible="False"></asp:Label>
                    </td>
                    <td align="right" style="width: 33px">
                        <asp:Label ID="Label2" runat="server" BorderStyle="None" ForeColor="White" Text="Available Credit Limit: "
                            Visible="False"></asp:Label>
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; font-size: 12px;">
                ...
                <tr valign="top">
                    ...
                    <td align="left" class="style1" colspan="4">
                        <asp:TextBox ID="txtCrAcc" runat="server" Font-Bold="False" Width="364px" 
                ...
                <tr valign="top">
                    ...
                    <td align="left" class="style1" colspan="4">
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="txtCrAcc"
                            ErrorMessage="RequiredFieldValidator" Font-Size="8pt" ForeColor="Red" 
                            ValidationGroup="btnPost">Enter Debit Account</asp:RequiredFieldValidator>
            ...
            <asp:Panel ID="Panel1" runat="server">
                <span style="color: #FFFFFF"><strong><span style="background-color: #CC33FF">Last Voucher
            ...
            <span style="color: #FFFFFF"><strong><span style="background-color: #CC6600">Today&#39;s
                Voucher List</span></strong></span><asp:GridView ID="gvTodayPayDet" runat="server"
