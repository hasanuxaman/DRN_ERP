<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="frmMprInq.aspx.cs" Inherits="DRN_WEB_ERP.Module.Procurement.Forms.frmMprInq" %>
                    ...
                    <table style="width: 100%; background-color: #CCFFFF; font-size: small;">
                        <tr>
                            ...
                            <td align="center" style="width: 300px">
                                <asp:Label ID="lblMsgValidity" runat="server" Font-Bold="True" 
                                    Font-Italic="True" Font-Size="10pt" ForeColor="Red" Visible="False"></asp:Label>
                            </td>
                            <td style="width: 94px">
                                &nbsp;
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="width: 94px">
                                <asp:LinkButton ID="lnkViewMpr" runat="server" onclick="lnkViewMpr_Click" 
                    ...
                    <asp:GridView ID="gvPoReqDet" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        <Columns>
                            ...
                            <%--<asp:TemplateField HeaderText="CS Ref. No">
                                <ItemTemplate>
                                    <asp:Label ID="lblCsRef" runat="server" Text='<%# Bind("CS_REF") %>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle Width="95px" />
                            </asp:TemplateField>--%>
                            <%--<asp:TemplateField HeaderText="PO Ref. No">
                                <ItemTemplate>
                                    <asp:Label ID="lblPoRefNo" runat="server" Text='<%# GetPoRef(Eval("REQ_HDR_REF").ToString(),Eval("REQ_ITEM_REF").ToString())%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>--%>
                            <%--<asp:TemplateField HeaderText="MRR Ref. No">
                                <ItemTemplate>
                                    <asp:Label ID="lblMrrRefNo" runat="server" Text='<%# GetMrrRef(Eval("REQ_HDR_REF").ToString(),Eval("REQ_ITEM_REF").ToString())%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>--%>
                            ...
                            <asp:TemplateField HeaderText="MRR Ref">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkMrrRef" runat="server" Text='<%# GetMrrRef(Eval("REQ_HDR_REF").ToString(),Eval("REQ_ITEM_REF").ToString())%>'
                                        OnClick="lnkMrrRef_Click"></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
