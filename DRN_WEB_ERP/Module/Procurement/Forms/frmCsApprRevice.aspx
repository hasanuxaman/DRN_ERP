<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="frmCsApprRevice.aspx.cs" Inherits="DRN_WEB_ERP.Module.Procurement.Forms.frmCsApprRevice" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div align="center" style="background-color: #00FF99">
        Revice Approved C/S</div>
    <asp:UpdatePanel ID="updpnl" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <div align="center" style="background-color: #00FFFF">
                <br />
                <br />
                <asp:Panel ID="pnlSearchBox" runat="server" DefaultButton="btnLoad">
                    <div>
                        Search Approved CS:&nbsp;<asp:TextBox ID="txtSearchCs" runat="server" CssClass="textAlignCenter search"
                            Width="500px" OnTextChanged="txtSearchCs_TextChanged"></asp:TextBox>
                        <cc1:AutoCompleteExtender ID="AutoCompleteExtenderSrchCs" runat="server" BehaviorID="AutoCompleteSrchCs"
                ...
                <asp:GridView ID="gvCsSum" runat="server" CellPadding="4" ForeColor="#333333" Font-Size="8pt"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Supplier Name" DataField="Par_Adr_Name" />
                ...
                &nbsp;<asp:Button ID="btnApp" runat="server" CssClass="btn2" OnClick="btnApp_Click"
                    Text="Revice" Width="100px" Visible="false" />
                <br />
                <asp:HiddenField ID="hfCsRef" runat="server" />
                <cc1:ModalPopupExtender ID="hfCsRef_ModalPopupExtender" runat="server" BackgroundCssClass="modalBackground"
                    CancelControlID="btnMsgOk" DropShadow="true" OkControlID="btnMsgOk" PopupControlID="pnlMsg"
                    TargetControlID="hfCsRef">
                </cc1:ModalPopupExtender>
                <cc1:ModalPopupExtender ID="hfCsRef_ModalPopupExtender2" runat="server" BackgroundCssClass="modalBackground"
                    CancelControlID="btnMsgOk" DropShadow="true" OkControlID="btnMsgOk" PopupControlID="pnlMsg"
                    TargetControlID="hfCsRef">
                </cc1:ModalPopupExtender>
            </div>
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="btnRej" EventName="Click" />
