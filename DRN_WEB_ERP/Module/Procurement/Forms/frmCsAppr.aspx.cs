...
{
    public partial class frmCsAppr : System.Web.UI.Page
    {
        ...
        protected void gvCsSum_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                var dtCsSum = taCsSum.GetDataByQtnPartyRef(ddllist.SelectedValue.ToString(), lblSupRef.ToString(), "QTN");
        ...
        protected void btnAppAll_Click(object sender, EventArgs e)
        {
            ...
            string qtnSupStr = "select distinct Par_Adr_Ref,Par_Adr_Name from tbl_Qtn_Det left outer join tbl_PuMa_Par_Adr on Qtn_Par_Code=Par_Adr_Ref where Qtn_Ref_No='" + ddllist.SelectedValue.ToString() + "'";
            SqlDataAdapter daSup = new SqlDataAdapter(qtnSupStr, connection);
            DataTable dtQtnSupData = new DataTable();
            daSup.Fill(dtQtnSupData);
        ...
        protected void ButtonOk_Click(object sender, EventArgs e)
        {
            ...
            csref = ddllist.SelectedValue.ToString();
            ...
            try
            {
                ...
                if (rowCnt > selectCnt)
                    ...
                    comments_det = "(Audit Recomended Party: " + party_det + ") " + txtcomments.Text.Trim();
                ...
                comm.InsertTranCom(csref, 2, DateTime.Now, uid, uname, desig, 1, "QTN", status, comments_det, "", "1", "", "", "", "");
        ...
        protected void btnApp_Click(object sender, EventArgs e)
        {
            ...
            string qtnSupStr = "select distinct Par_Adr_Qtn_Ref,Par_Adr_Qtn_Name from tbl_Qtn_Det left outer join tbl_PuMa_Par_Adr_Qtn on Qtn_Par_Code=Par_Adr_Qtn_Ref where Qtn_Ref_No='" + ddllist.SelectedValue.ToString() + "'";
            SqlDataAdapter daSup = new SqlDataAdapter(qtnSupStr, connection);
            DataTable dtQtnSupData = new DataTable();
            daSup.Fill(dtQtnSupData);
            if (dtQtnSupData.Rows.Count > 0)
