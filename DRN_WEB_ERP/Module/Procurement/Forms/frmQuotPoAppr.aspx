<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="frmQuotPoAppr.aspx.cs" Inherits="DRN_WEB_ERP.Module.Procurement.Forms.frmQuotPoAppr" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div align="center" style="background-color: #00FF99">
        Purchase Order (P/O) Approval</div>
    <style type="text/css">
        .style1
        {
            height: 29px;
                        ...
                        <td colspan="3" class="tbl">
                            <table id="tbl_product" width="100%" runat="server" style="border-top-width: 1px;
                                ...
                                <tr>
                                    <td colspan="3" style="text-align: center">
                                        &nbsp; &nbsp;
                                        <asp:Button ID="btnapp" runat="server" CssClass="btn2" OnClick="btnapp_Click" Text="Approve" />
                                    </td>
                                </tr>
                                <tr>
