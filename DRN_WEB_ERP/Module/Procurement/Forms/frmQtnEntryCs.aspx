<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    EnableEventValidation="false" ValidateRequest="false" CodeBehind="frmQtnEntryCs.aspx.cs"
    Inherits="DRN_WEB_ERP.Module.Procurement.Forms.frmQtnEntryCs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div align="center" style="background-color: #00FF99">
        Quotation Entry from CS</div>
    <div style="background-color: #f0f8ff">
        <div>
            <br />
            <asp:Label ID="lblcurlist" runat="server" Text="Label" BackColor="#FFCCFF"></asp:Label>
            <br />
            <br />
            <asp:GridView ID="gdItem" runat="server" BackColor="White" BorderColor="#6B7EBF"
                ...
                text-align: left;" Width="98%" Font-Size="8pt">
        ...
        <div align="center">
            <asp:Button ID="btngoback" runat="server" CssClass="btn2" Text="BACK TO CS APPROVAL"
                Width="205px" OnClick="btngoback_Click" Visible="False" />
        </div>
        <br />
        <div align="center" style="border: 1px dashed #006699">
            ...
            <asp:Button ID="btnAddQtnSup" runat="server" onclick="btnAddQtnSup_Click" 
                Text="Add New..." />
            &nbsp; Submit Date:
        ...
        <div>
            <uc1:CtlQtnEntry ID="ctlquo" runat="server" />
        </div>
        <div>
        ...
        <div>
            <b>Above quotetion valid upto
                <asp:TextBox ID="txtvaliddays" runat="server" Width="50px" 
