...
{
    public partial class frmShowProcReport : System.Web.UI.Page
    {
        ...
        private void show_report()
        {
            ...
            try
            {
                ...
                //cryRpt.ExportToHttpResponse(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, Response, true, "Crystal.pdf");
                //Response.End();

                //cryRpt.RecordSelectionFormula = rptFormula;

                //cryRpt.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, true, "ExportedReport");


                //ConvertCrReportToPDF("001", cryRpt, @"C:\");
        ...
        public static void ConvertCrReportToPDF(string InputID, ReportDocument DocReport, string SavePath)
        {
            ...
            diskOpts.DiskFileName = SavePath + InputID + ".pdf";
            // This is the path where the file will be saved
            exportOpts.DestinationOptions = diskOpts;

            DocReport.Export();

            System.Web.HttpContext.Current.Response.Redirect(SavePath + InputID + ".pdf");

            //System.Web.HttpResponse.Redirect(@"http://localhost/DRN_WEB_ERP/" + SavePath + InputID + ".pdf", false);
        }
