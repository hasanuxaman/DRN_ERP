<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="frmSupplierQtn.aspx.cs" Inherits="DRN_WEB_ERP.Module.Procurement.Forms.frmSupplierQtn" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div align="center" style="background-color: #00FF99">
        Quoted Supplier Entry</div>
                    ...
                    <asp:GridView ID="gvSup" runat="server" AutoGenerateColumns="False" BackColor="White"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Sup. Ref.">
                                <ItemTemplate>
                                    <asp:HiddenField ID="hfCustRef" runat="server" Value='<%# Bind("Par_Adr_Qtn_Ref") %>' />
                                    <asp:Label ID="lblCustRefNo" runat="server" Text='<%# Bind("Par_Adr_Qtn_Ref_No") %>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle Width="80px" />
                            </asp:TemplateField>
                            <asp:BoundField DataField="Par_Adr_Qtn_Name" HeaderText="Name" SortExpression="Par_Adr_Name">
                                <ItemStyle Width="150px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="Par_Adr_Qtn_Addr" HeaderText="Address">
                                <ItemStyle Width="200px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="Par_Adr_Qtn_Cont_Per" HeaderText="Contact Person">
                                <ItemStyle Width="100px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="Par_Adr_Qtn_Cell_No" HeaderText="Cell No">
                                <ItemStyle Width="80px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="Par_Adr_Qtn_Tel_No" HeaderText="Phone No">
                                <ItemStyle Width="80px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="Par_Adr_Qtn_Fax_No" HeaderText="Fax No">
                                <ItemStyle Width="80px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="Par_Adr_Qtn_Email_Id" HeaderText="Email">
                                <ItemStyle Width="100px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="Par_Adr_Qtn_Status" HeaderText="Status" />
                        </Columns>
