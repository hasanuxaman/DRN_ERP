<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="frmInvRptIssue.aspx.cs" Inherits="DRN_WEB_ERP.Module.Inventory.Forms.frmInvRptIssue" %>
                ...
                <div>
                    <table style="width: 100%; font-size: 12px; background-color: #CCFFFF;">
                        ...
                        <tr>
                            ...
                            <td align="right" style="width: 166px; background-color: #CCCCCC;" width="280">
                                <asp:RadioButtonList ID="optSrchType" runat="server" RepeatDirection="Horizontal"
                                    Width="279px" Style="margin-right: 0px" AutoPostBack="True" 
                                    OnSelectedIndexChanged="optSrchType_SelectedIndexChanged">
                                    <asp:ListItem Value="1" Selected="True">Item Wise</asp:ListItem>
                                    <asp:ListItem Value="2">Issued To</asp:ListItem>
