...
{
    public partial class frmStoreReqAppr : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //if (suprRef == "000515" || suprRef == "000776" || suprRef == "000011")//Abdullah,Bharat
                if (suprRef == "000856" || suprRef == "000011")//Ali Haider
                    dtPoHdr = taPoHdr.GetDataByAppr(suprRef);
                //else if (suprRef == "000148" || suprRef == "000011")
                //    dtPoHdr = taPoHdr.GetDataByFwd(suprRef);
                else
                    dtPoHdr = taPoHdr.GetDataBySupRef(suprRef);
            ...
            try
            {
                ...
                if (e.CommandName == "Forward")
                {
                    if (dtPoHdr.Rows.Count > 0)
                    {
                        ...
                        taPoDet.UpdatePoApprQty(Convert.ToDouble(txtPoQty.Text.Trim()), Convert.ToDouble(lblPoReqQty.Text.Trim()),
                            dtPoDet[0].T_C1 + ", \n" + "Appr By:- " + supName + " @" + DateTime.Now, "H", dtPoDet[0].T_In + 1,
                            hfPoRef.Value.ToString(), lblPoItemCode.Text, Convert.ToInt16(hfPoDetLno.Value.ToString()));
                ...
                //if (suprRef == "000515" || suprRef == "000776" || suprRef == "000011")//Abdullah,Bharat
                if (suprRef == "000856" || suprRef == "000011")//Ali Haider
                    dtPoHdrNew = taPoHdrNew.GetDataByAppr(suprRef);
                //else if (suprRef == "000148" || suprRef == "000011")
                //    dtPoHdrNew = taPoHdrNew.GetDataByFwd(suprRef);
                else
                    dtPoHdrNew = taPoHdrNew.GetDataBySupRef(suprRef);
        ...
        protected void gvPendPo_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                try
                {
                    ...
                    var lblItemCode = (Label)(e.Row.FindControl("lblPoItemCode"));
        ...
        protected void ddlStore_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            var lblItemCode = (Label)(row.FindControl("lblPoItemCode"));
