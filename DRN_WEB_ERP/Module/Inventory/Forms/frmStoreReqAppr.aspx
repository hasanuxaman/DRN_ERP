<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="frmStoreReqAppr.aspx.cs" Inherits="DRN_WEB_ERP.Module.Inventory.Forms.frmStoreReqAppr" %>
            ...
            <div align="center" style="width: 100%; background-color: #CCFFFF;">
                ...
                <asp:Panel ID="Panel1" runat="server" GroupingText="Pending Store Requisition">
                    ...
                    <asp:GridView ID="gvPendPo" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ForeColor="#333333" Font-Size="7pt" OnRowCommand="gvPendPo_RowCommand" OnRowDataBound="gvPendPo_RowDataBound">
