<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="frmStoreReqIssu.aspx.cs" Inherits="DRN_WEB_ERP.Module.Inventory.Forms.frmStoreReqIssu" %>
    ...
    <asp:UpdatePanel ID="updpnl" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <div align="center" style="width: 100%; background-color: #CCFFFF;">
                <br />
                <asp:Panel ID="Panel1" runat="server" GroupingText="Approved Store Requisition">
                    <br />
                    ...
                    <asp:GridView ID="gvPendPo" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ForeColor="#333333" Font-Size="7pt" OnRowDataBound="gvPendPo_RowDataBound">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" class="preview" Target="_blank" NavigateUrl='<%# Eval("EmpRefNo", "~/Module/HRMS/Tools/getEmpPic.ashx?EmpRefNo={0}") %>'
                                        runat="server">
                                        <asp:Image ID="AttachImage" runat="server" Height="40px" Width="45px" ImageUrl="~/Image/NoImage.gif" /></asp:HyperLink>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Requsition_By">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Purpose">
                                <ItemTemplate>
                                    <asp:HiddenField ID="hfReqFor" runat="server" Value='<%# Bind("PO_Hdr_Com2") %>' />
                                    <asp:Label ID="lblReqFor" runat="server" Text='<%# Bind("PO_Hdr_Com3") %>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle Width="70px" />
                            </asp:TemplateField>
                            <asp:BoundField DataField="PO_Hdr_Com9" HeaderText="Required_For">
                                <ItemStyle Width="70px" />
                            </asp:BoundField>
                            ...
                            <asp:TemplateField HeaderText="Item Name">
                                ...
                                <ItemStyle BackColor="#FFCCFF" HorizontalAlign="Center" Width="150px" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Stock">
                                <ItemTemplate>
                                    <asp:Label ID="lblStock" runat="server" Font-Bold="True"></asp:Label>
                                    <%--Text='<%# GetCurStk(Eval("Itm_Det_Ext_Data2").ToString(),Eval("PO_Det_Icode").ToString())%>'--%>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" Width="50px" />
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:CheckBox ID="optSelect" runat="server" AutoPostBack="True" OnCheckedChanged="optSelect_CheckedChanged" />
                                </ItemTemplate>
                                <ItemStyle Width="10px" />
                            </asp:TemplateField>
                            <asp:TemplateField ShowHeader="False">
                                <ItemTemplate>
                                    <asp:Button ID="btnCancel" runat="server" Text="Cancel" CommandName="Cancel" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                        OnClick="btnCancel_Click" OnClientClick="return confirm('Do you want to Cancel?')"
                                        Enabled="false" />
                                </ItemTemplate>
                    ...
                    <br />
                    <asp:Button ID="btnIssue" runat="server" OnClick="btnIssue_Click" Text="Issue Selected Item"
                        Visible="False" />
                    <br />
                    <br />
                </asp:Panel>
        ...
        <Triggers>
            <asp:AsyncPostBackTrigger ControlID="cboReqBy" EventName="SelectedIndexChanged" />
            <asp:AsyncPostBackTrigger ControlID="gvPendPo" EventName="RowCommand" />
            <asp:AsyncPostBackTrigger ControlID="gvPendPo" EventName="RowDataBound" />
