<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="frmInvRptPro.aspx.cs" Inherits="DRN_WEB_ERP.Module.Inventory.Forms.frmInvRptPro" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div align="center" style="background-color: #00FF99">
        Promotional Item Issue/Receive Report</div>
            ...
            <div align="center">
                <table style="width: 100%; font-size: 12px; background-color: #CCFFFF;">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <asp:RadioButtonList ID="optRptType" runat="server" 
                                RepeatDirection="Horizontal">
                                <asp:ListItem Selected="True" Value="1">Issue</asp:ListItem>
                    ...
                    <tr>
                        ...
                        <td align="center" style="width: 127px">
                            &nbsp;</td>
                        <td align="center" style="width: 127px">
                            <asp:Button ID="btnShowDet" runat="server" OnClick="btnShowDet_Click" 
                                Text="Details" ValidationGroup="btnShow" Width="100px" />
                        </td>
                        <td style="width: 6px">
                            &nbsp;
                        </td>
                        <td align="center">
                            <asp:Button ID="btnShowSum" runat="server" OnClick="btnShowSum_Click" Text="Summary"
