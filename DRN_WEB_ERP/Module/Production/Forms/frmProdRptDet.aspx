<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="frmProdRptDet.aspx.cs" Inherits="DRN_WEB_ERP.Module.Production.Forms.frmProdRptDet" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div align="center" style="background-color: #00FF99">
        Production Details Report</div>
    <asp:UpdatePanel ID="updpnl" runat="server" UpdateMode="Conditional">
                    ...
                    <tr>
                        ...
                        <td colspan="4">
                            <asp:RadioButtonList ID="optProdRpt" runat="server" RepeatDirection="Horizontal"
                                AutoPostBack="True" OnSelectedIndexChanged="optProdRpt_SelectedIndexChanged">
                                <asp:ListItem Selected="True" Value="RC">FG Production</asp:ListItem>
                                <asp:ListItem Value="IS">RM Consumption</asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
                        <td style="width: 127px">
                            &nbsp;
        ...
        <Triggers>
            <asp:AsyncPostBackTrigger ControlID="optProdRpt" EventName="SelectedIndexChanged" />
        </Triggers>
    </asp:UpdatePanel>
