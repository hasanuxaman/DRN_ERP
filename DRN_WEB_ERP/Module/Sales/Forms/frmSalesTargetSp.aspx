<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="frmSalesTargetSp.aspx.cs" Inherits="DRN_WEB_ERP.Module.Sales.Forms.frmSalesTargetSp" %>
    ...
    <asp:UpdatePanel ID="updpnl" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <div align="center" style="background-color: #00FF99">
                Sales Target Setup for Sales Person (SP)</div>
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td align="left" style="width: 228px">
                                <asp:DropDownList ID="cboDsm" runat="server" Width="230px" AutoPostBack="True" OnSelectedIndexChanged="cboDsm_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                    ...
                    <asp:GridView ID="gvSalesTarget" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="SP Ref">
                                <ItemTemplate>
                                    <asp:Label ID="lblSpRef" runat="server" Text='<%# Bind("Sp_Ref") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="SP Name">
                                <ItemTemplate>
                                    <asp:Label ID="lblSpName" runat="server" Text='<%# Bind("Sp_Full_Name") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Sales Zone">
                                <ItemTemplate>
                                    <asp:Label ID="lblSpSalesZone" runat="server" Text='<%# Bind("SalesZoneName") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Regular">
                                <ItemTemplate>
                                    ...
                                    <asp:TextBox ID="txtTrgReg" runat="server" Width="100px" CssClass="textAlignRight"
                                        Text='<%# GetSlsTrgt(Eval("Sp_Ref").ToString(),("100002").ToString())%>'></asp:TextBox>
                            ...
                            <asp:TemplateField HeaderText="Supreme">
                                <ItemTemplate>
                                    ...
                                    <asp:TextBox ID="txtTrgtSup" runat="server" Width="100px" CssClass="textAlignRight"
                                        Text='<%# GetSlsTrgt(Eval("Sp_Ref").ToString(),("100001").ToString())%>'></asp:TextBox>
                            ...
                            <asp:TemplateField HeaderText="Eastern (PCC)">
                                <ItemTemplate>
                                    ...
                                    <asp:TextBox ID="txtTrgtEstPcc" runat="server" Width="100px" CssClass="textAlignRight"
                                        Text='<%# GetSlsTrgt(Eval("Sp_Ref").ToString(),("100003").ToString())%>'></asp:TextBox>
                            ...
                            <asp:TemplateField HeaderText="Eastern (OPC)">
                                <ItemTemplate>
                                    ...
                                    <asp:TextBox ID="txtTrgtEstOpc" runat="server" Width="100px" CssClass="textAlignRight"
                                        Text='<%# GetSlsTrgt(Eval("Sp_Ref").ToString(),("100004").ToString())%>'></asp:TextBox>
                            ...
                            <asp:TemplateField HeaderText="Collection">
                                <ItemTemplate>
                                    ...
                                    <asp:TextBox ID="txtTrgtCollect" runat="server" Width="120px" CssClass="textAlignRight"
                                        Text='<%# GetSlsTrgt(Eval("Sp_Ref").ToString(),("100000").ToString())%>'></asp:TextBox>
