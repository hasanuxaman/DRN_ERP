<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="frmSalesOrderRptWing.aspx.cs" Inherits="DRN_WEB_ERP.Module.Sales.Forms.frmSalesOrderRptWing" %>
                        ...
                        <tr>
                            ...
                            <td align="center" colspan="9">
                                <asp:RadioButtonList ID="optRpt" runat="server" RepeatDirection="Horizontal">
                                    ...
                                    <asp:ListItem Value="5">Challan Report</asp:ListItem>
                                    <asp:ListItem Value="6">Collection</asp:ListItem>
                                    <asp:ListItem Value="7">Customer Ledger</asp:ListItem>
                                </asp:RadioButtonList>
                            </td>
                            <td style="width: 15px">
                                &nbsp;
                        ...
                        <tr>
                            ...
                            <td style="width: 136px">
                                ...
                                <cc1:AutoCompleteExtender ID="AutoCompleteExtenderSrch" runat="server" BehaviorID="AutoCompleteSrch"
                                    ...
                                    DelimiterCharacters="," MinimumPrefixLength="1" ServiceMethod="GetSrchCustomerByWing"
