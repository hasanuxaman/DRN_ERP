...
{
    public partial class frmEngTour : System.Web.UI.Page
    {
        ...
        private void LoadPendData()
        {
            ...
            try
            {
                var dtPlanDet = taTourPlan.GetDataByPend(ddlEngName.SelectedValue.ToString(), "ENG");
        ...
        private void LoadTourData()
        {
            ...
            try
            {
                var dtTourDet = taTour.GetDataByEmp(ddlEngName.SelectedValue.ToString(), Convert.ToDateTime(txtTourFromDt.Text), Convert.ToDateTime(txtTourToDt.Text), "ENG");
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var dtTour = taTour.GetMaxTourRef(Convert.ToDateTime(txtVisitDateTbl.Text).Year, "P", "ENG");
                var tourRef = dtTour == null ? 1 : Convert.ToInt32(dtTour) + 1;
                ...
                taTour.InsertTour("TUR-EN-" + nextTourRef.ToString(), ddlEngName.SelectedValue.ToString(), "", txtCompNameTbl.Text,
                                ...
                                txtRemTbl.Text.Trim(), "", "ENG", DateTime.Now, Session["sessionUserId"] == null ? "0" : Session["sessionUserId"].ToString(), "1", "P");
                myTran.Commit();
                tblMsg.Rows[0].Cells[0].InnerText = "Data saved successfully.";
                tblMsg.Rows[1].Cells[0].InnerText = "";
                ModalPopupExtenderMsg.Show();
        ...
        protected void btnRemOk_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dtTourPlan.Rows.Count > 0)
                {
                    var dtTour = taTour.GetMaxTourRef(Convert.ToDateTime(txtRemVisitDt.Text).Year, "P", "ENG");
                    var tourRef = dtTour == null ? 1 : Convert.ToInt32(dtTour) + 1;
                    ...
                    taTour.InsertTour("TUR-EN-" + nextTourRef.ToString(), ddlEngName.SelectedValue.ToString(), dtTourPlan[0].Tem_Plan_Ref, dtTourPlan[0].Tem_Plan_Com,
                        dtTourPlan[0].Tem_Plan_Com_Adr, dtTourPlan[0].Tem_Plan_Com_Cont_No, dtTourPlan[0].Tem_Plan_Com_Cont_Name, dtTourPlan[0].Tem_Plan_Com_Cont_Ref,
                        ...
                        txtPendRem.Text.Trim(), "", "ENG", DateTime.Now, Session["sessionUserId"] == null ? "0" : Session["sessionUserId"].ToString(), "1", "P");
