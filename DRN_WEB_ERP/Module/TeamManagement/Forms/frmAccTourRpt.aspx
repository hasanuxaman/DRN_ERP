<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="frmAccTourRpt.aspx.cs" Inherits="DRN_WEB_ERP.Module.TeamManagement.Forms.frmAccTourRpt" %>
            ...
            <asp:GridView ID="gvTourPlan" runat="server" AutoGenerateColumns="False" Font-Size="8pt"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Plan Date" SortExpression="Tem_Plan_Tour_Date">
                        <ItemTemplate>
                            <asp:Label ID="lblPlanDate" runat="server" Text='<%# Eval("Tem_Plan_Tour_Date", "{0:dd-MM-yyyy}") %>'
