<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="frmAccTourPlan.aspx.cs" Inherits="DRN_WEB_ERP.Module.TeamManagement.Forms.frmAccTourPlan" %>
                        ...
                        <fieldset style="background-color: #99CCFF">
                            ...
                            <div align="center">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DRNConStr %>"
                                    SelectCommand="SELECT * FROM [tbl_Team_Tour_Purpose] where [RefFlag]='CRD'">
                                </asp:SqlDataSource>
                                <br />
                            </div>
                        </fieldset>
