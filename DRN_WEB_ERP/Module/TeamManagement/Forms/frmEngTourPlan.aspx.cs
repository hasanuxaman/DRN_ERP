...
{
    public partial class frmEngTourPlan : System.Web.UI.Page
    {
        ...
        private void LoadSavedData()
        {
            ...
            try
            {
                ...
                dt = (DataTable)ViewState["dtPlanDet"];
                var dtPlanDet = taTourPlan.GetDataByEmp(ddlEngName.SelectedValue.ToString(), Convert.ToDateTime(txtPlanFromDt.Text), Convert.ToDateTime(txtPlanToDt.Text), "ENG");
        ...
        protected void btnPost_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var dtTourPlan = taTourPlan.GetMaxPlanRef(Convert.ToDateTime(txtPlanDateTbl.Text).Year, "P", "ENG");
                ...
                taTourPlan.UpdatePlanFlag("PLN-EN-" + nextPlanRef, "P", hfPlanId.Value.ToString());
        ...
        protected void gvTourPlan_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            try
            {
                ...
                taTourPlan.UpdateTourPlan(ddlEngName.SelectedValue.ToString(), txtCompNameEdit, txtCompAdrEdit, txtCompContNoEdit, txtCompContNameEdit, txtCompContDesigEdit,
                   ...
                   txtVisitNoEdit, "", "", "ENG", DateTime.Now, Session["sessionUserId"] == null ? "0" : Session["sessionUserId"].ToString(), "1", "H", hfPlanIdEdit);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var dtTourPlan = taTourPlan.GetMaxPlanRef(Convert.ToDateTime(txtPlanDateTbl.Text).Year, "H", "ENG");
                var planRef = dtTourPlan == null ? 1 : Convert.ToInt32(dtTourPlan) + 1;
                var nextPlanRef = Convert.ToDateTime(txtPlanDateTbl.Text).ToString("MM") + Convert.ToDateTime(txtPlanDateTbl.Text).ToString("yy") + "-" + planRef.ToString("000000");
                ...
                taTourPlan.InsertTourPlan("TMP-" + nextPlanRef, ddlEngName.SelectedValue.ToString(), txtCompNameTbl.Text.Trim(), txtCompAdrTbl.Text.Trim(),
                    ...
                    txtVisitNo.Text.Trim(), "", "", "ENG", DateTime.Now, Session["sessionUserId"] == null ? "0" : Session["sessionUserId"].ToString(), "1", "H");
