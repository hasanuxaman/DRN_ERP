<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="frmEmpMas.aspx.cs" Inherits="DRN_WEB_ERP.Module.HRMS.Forms.frmEmpMas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div align="center" style="font-weight: bold; font-style: italic; font-variant: normal;
        text-transform: capitalize; background-color: #00FF99">
    ...
    <div align="center" style="background-color: #CCFFFF">
        <table style="width: 100%;" align="center">
            <tr>
                ...
                <td valign="middle" align="center" rowspan="3" style="width: 166px">
                ...
                <td valign="middle" align="left" class="style1">
                    <asp:Button ID="btnViewProfile" runat="server" OnClick="btnViewProfile_Click" 
                        Text="View Profile" Enabled="False" Width="212px" Visible="False" />
                </td>
                <td valign="middle" align="left">
                </td>
            </tr>
            <tr>
                ...
                <td valign="middle" align="left" class="style1">
                    <asp:Button ID="btnSettle" runat="server" OnClick="btnSettle_Click" Text="Inactive/Separation"
    ...
    <div align="center" style="background-color: #99FF33">
        <span style="float: left; width: 50%; background-color: #99FF33;">
            <asp:LinkButton ID="lnkBtnPrev" runat="server" OnClick="btnPrev_Click">&lt;&lt;Prev</asp:LinkButton></span>
        <span style="float: right; width: 50%; background-color: #99FF33;">
            <asp:LinkButton ID="lnkBtnNext" runat="server" OnClick="btnNext_Click">Next&gt;&gt;</asp:LinkButton></span>
    </div>
    <div>
        <br />
    </div>
                    ...
                    <asp:Panel ID="PnlOffice" runat="server" DefaultButton="btnSaveOffInfo">
                        <table style="width: 100%; background-color: #CCFFFF">
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="cboShift" runat="server" Width="205px">
                                    </asp:DropDownList>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="cboGrade" runat="server" Width="205px">
                                    </asp:DropDownList>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="cboSec" runat="server" Width="400px">
                                    </asp:DropDownList>
                                </td>
                                <td style="width: 69px">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="cboDesig" runat="server" Width="400px">
                                    </asp:DropDownList>
                                </td>
                                <td style="width: 69px">
                                ...
                                <td>
                                    <asp:TextBox ID="txtSalBankAcc" runat="server" Width="200px"></asp:TextBox>
                                </td>
                                <td>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:TextBox ID="txtSupr" runat="server" CssClass="search" ForeColor="#0066FF" Width="380px"></asp:TextBox>
                                    <asp:AutoCompleteExtender ID="AutoCompleteExtenderSupr" runat="server" BehaviorID="AutoCompleteSrchSupr"
                                        ...
                                        OnClientPopulated="acePopulated" ServiceMethod="GetSrchEmp" ServicePath="~/Module/HRMS/Forms/wsAutoComHrms.asmx"
                                        ShowOnlyCurrentWordInCompletionListItem="True" TargetControlID="txtSupr">
                                    </asp:AutoCompleteExtender>
                                </td>
                                <td style="width: 69px">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="txtSupr"
                                        ErrorMessage="Enter Reporting Person Name" ForeColor="Red" ValidationGroup="SaveOffcInfo">*</asp:RequiredFieldValidator>
                                </td>
                                <td width="100">
                                    TA
                                </td>
                                ...
                                <td>
                                    <asp:TextBox ID="txtTA" runat="server" Width="200px"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender ID="txtTA_FilteredTextBoxExtender" runat="server" Enabled="True"
                                        FilterType="Custom, Numbers" TargetControlID="txtTA" ValidChars=".">
                                    </asp:FilteredTextBoxExtender>
                                </td>
                                <td>
                                    <asp:CompareValidator ID="CompareValidator12" runat="server" ControlToValidate="txtTA"
                                        ErrorMessage="Enter Valid TA Amount" ForeColor="Red" Operator="DataTypeCheck"
                                        Type="Currency" ValidationGroup="SaveOffcInfo">*</asp:CompareValidator>
                                </td>
                                <td>
                                    &nbsp;
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtDA" runat="server" Width="200px"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender ID="txtDA_FilteredTextBoxExtender" runat="server" Enabled="True"
                                        FilterType="Custom, Numbers" TargetControlID="txtDA" ValidChars=".">
                                    </asp:FilteredTextBoxExtender>
                                </td>
                                <td class="style14">
                                    <asp:CompareValidator ID="CompareValidator13" runat="server" ControlToValidate="txtDA"
                                        ErrorMessage="Enter Valid DA Amount" ForeColor="Red" Operator="DataTypeCheck"
                                        Type="Currency" ValidationGroup="SaveOffcInfo">*</asp:CompareValidator>
                                </td>
                                <td class="style14">
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="cboJobStat" runat="server" Width="205px">
                                    </asp:DropDownList>
                                </td>
                                <td style="width: 69px">
                                ...
                                <td>
                                    <asp:TextBox ID="txtOthAllowence" runat="server" Width="200px"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender ID="txtOthAllowence_FilteredTextBoxExtender" runat="server"
                                        Enabled="True" FilterType="Custom, Numbers" TargetControlID="txtOthAllowence"
                                        ValidChars=".">
                                    </asp:FilteredTextBoxExtender>
                                </td>
                                <td>
                                    <asp:CompareValidator ID="CompareValidator14" runat="server" ControlToValidate="txtOthAllowence"
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtConfDueDate" runat="server" Width="200px"></asp:TextBox>
                                ...
                                <td>
                                    <asp:TextBox ID="txtOffEmail" runat="server" Width="200px"></asp:TextBox>
                                </td>
                                <td>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtConfDate" runat="server" Width="200px"></asp:TextBox>
                                ...
                                <td>
                                    <asp:TextBox ID="txtOffPhone" runat="server" Width="200px"></asp:TextBox>
                                </td>
                                <td>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="cboEmpType" runat="server" Width="205px">
                                    </asp:DropDownList>
                                </td>
                                <td style="width: 69px">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ControlToValidate="cboEmpType"
                                        ErrorMessage="Select Employee Type" ForeColor="Red" InitialValue="0" ValidationGroup="SaveOffcInfo">*</asp:RequiredFieldValidator>
                                </td>
                                <td width="100">
                                    PABX
                                </td>
                                ...
                                <td>
                                    <asp:TextBox ID="txtOffPabx" runat="server" Width="200px"></asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtOffIpPhone" runat="server" Width="200px"></asp:TextBox>
                                </td>
                                <td>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtEmpRemarks" runat="server" Width="200px"></asp:TextBox>
                                </td>
                                <td style="width: 69px">
                                    &nbsp;
                                </td>
                                ...
                                <td>
                                    <asp:DropDownList ID="cboWrkStation" runat="server" Width="205px">
                                    </asp:DropDownList>
                                </td>
                                <td>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator32" runat="server" ControlToValidate="cboWrkStation"
                                        ErrorMessage="Select Work Station" ForeColor="Red" InitialValue="0" ValidationGroup="SaveOffcInfo">*</asp:RequiredFieldValidator>
                                </td>
                                <td>
                                    &nbsp;
                                </td>
                                ...
                                <ContentTemplate>
                                    <table style="width: 100%; background-color: #CCFFFF">
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #C0C0C0; width: 64px;">
                                                <asp:Button ID="btnUpdateSig" runat="server" Text="Update Sig" OnClick="btnUpdateSig_Click"
                                                    ValidationGroup="sigUpdate" Visible="false" />
                                            </td>
                                            <td style="border: 1px solid #C0C0C0; width: 40px;">
                                                <asp:Button ID="btnDeleteSig" runat="server" Text="Delete Sig" OnClick="btnDeleteSig_Click"
                                                    Visible="false" />
                                            </td>
                                            <td>
                                            </td>
    ...
    <asp:Panel ID="pnlSettle" runat="server" Style="border-right: black 2px solid; padding-right: 20px;
        display: none; border-top: black 2px solid; padding-left: 20px; padding-bottom: 20px;
        border-left: black 2px solid; padding-top: 20px; border-bottom: black 2px solid;
        background-color: #E1FBF1" ForeColor="Blue" Width="560px" Font-Size="Small">
        <table id="tblSettle" runat="server" style="width: 100%;">
            ...
            <tr>
                <td align="right" class="style16">
                    Final Settelement Amount
                </td>
                <td>
                    <asp:TextBox ID="txtFinalSettlAmt" runat="server" TextMode="Number"></asp:TextBox>
                    <asp:FilteredTextBoxExtender ID="txtFinalSettlAmt_FilteredTextBoxExtender" runat="server"
                        Enabled="True" FilterType="Custom, Numbers" TargetControlID="txtFinalSettlAmt"
                        ValidChars=".">
                    </asp:FilteredTextBoxExtender>
                </td>
            </tr>
