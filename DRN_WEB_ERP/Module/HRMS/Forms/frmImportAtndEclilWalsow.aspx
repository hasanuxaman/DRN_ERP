<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="frmImportAtndEclilWalsow.aspx.cs" Inherits="DRN_WEB_ERP.Module.HRMS.Forms.frmImportAtndEclilWalsow" %>
            ...
            <ContentTemplate>
                <table style="width: 100%; font-size: 12px; background-color: #CCFFFF">
                    ...
                    <tr>
                        ...
                        <td align="center" style="width: 275px">
                            &nbsp;
                            <asp:Button ID="btnDbConStat" runat="server" OnClick="btnDbConStat_Click" Text="DB Connection Status" />
                            <br />
