<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="frmImportAtndEclilFact.aspx.cs" Inherits="DRN_WEB_ERP.Module.HRMS.Forms.frmImportAtndEclilFact" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div align="center" style="background-color: #00FF99">
        ECIL Factory Import Attendance</div>
    <div align="center">
            ...
            <ContentTemplate>
                <table style="width: 100%; font-size: 12px; background-color: #CCFFFF">
                    ...
                    <tr>
                        ...
                        <td align="center" style="width: 275px">
                            &nbsp;
                            <asp:Button ID="btnDbConStat" runat="server" onclick="btnDbConStat_Click" 
                                Text="DB Connection Status" />
                            <br />
                            <asp:Label ID="lblDbConStat" runat="server" ForeColor="#FF0066"></asp:Label>
                        </td>
                        <td align="center">
                            &nbsp;
                        </td>
