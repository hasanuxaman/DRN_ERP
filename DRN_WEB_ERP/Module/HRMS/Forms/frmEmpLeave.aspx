<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="frmEmpLeave.aspx.cs" Inherits="DRN_WEB_ERP.Module.HRMS.Forms.frmEmpLeave" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="updpnl" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <div style="border: 1px solid #CCCCCC; width: 55%; height: 320px; background-color: #CCFFFF;">
                <table style="width: 100%; background-color: #CCFFFF;">
                    ...
                    <tr>
                        ...
                        <td style="width: 300px">
                            <asp:TextBox ID="txtLvFrmDt" runat="server" CssClass="etc" AutoPostBack="True" OnTextChanged="txtLvFrmDt_TextChanged"></asp:TextBox>
                            ...
                            <asp:CompareValidator ID="CompareValidator2" runat="server" ControlToValidate="txtLvFrmDt"
                                ErrorMessage="Enter Valid From Date" ForeColor="Red" Operator="DataTypeCheck"
                    ...
                    <tr>
                        ...
                        <td style="width: 300px">
                            <asp:TextBox ID="txtLvToDt" runat="server" CssClass="etc" AutoPostBack="True" OnTextChanged="txtLvToDt_TextChanged"></asp:TextBox>
                            ...
                            <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="txtLvToDt"
                                ErrorMessage="Enter Valid To Date" ForeColor="Red" Operator="DataTypeCheck" Type="Date"
                            ...
                            <asp:CompareValidator ID="CompareValidator3" runat="server" ControlToValidate="txtLvToDt"
                                ErrorMessage="To Date should be after Date From" ForeColor="Red" Operator="GreaterThanEqual"
                    ...
                    <tr>
                        ...
                        <td style="width: 300px">
                            ...
                            <asp:Button ID="btnSave" runat="server" CssClass="btn" OnClick="btnSave_Click" Text="Apply"
            ...
            <div align="center" style="width: 100%; background-color: #CCFFFF;">
                ...
                <asp:Panel ID="Panel1" runat="server" GroupingText="Pending Leave List">
                    <br />
                    <asp:GridView ID="gvEmpPendLv" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ForeColor="#333333" Font-Size="8pt" OnRowDeleting="gvEmpPendLv_RowDeleting" OnRowDataBound="gvEmpPendLv_RowDataBound">
                        <AlternatingRowStyle BackColor="White" />
                        <Columns>
                            ...
                            <asp:BoundField DataField="LvDetAppDate" DataFormatString="{0:d}" HeaderText="Apply Date" />
                            ...
                            <asp:TemplateField HeaderText="Leave Date">
                                <ItemTemplate>
                                    <asp:HiddenField ID="hfLvRef" runat="server" Value='<%# Bind("LvDetFlag") %>' />
            ...
            <div align="center" style="width: 100%; background-color: #CCFFFF;">
                <br />
                <asp:Panel ID="pnlEmpAppLv" runat="server" GroupingText="Approved Leave List">
                    <br />
                    Select Year:
                    ...
                    <asp:GridView ID="gvEmpApprLv" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ForeColor="#333333" Font-Size="8pt" OnRowDeleting="gvEmpApprLv_RowDeleting" OnRowDataBound="gvEmpApprLv_RowDataBound"
                        ShowFooter="True">
                        <AlternatingRowStyle BackColor="White" />
                        <Columns>
                            <asp:TemplateField HeaderText="SL#">
                            ...
                            <asp:TemplateField HeaderText="Leave Date">
                                ...
                                <ItemStyle Font-Bold="True" Width="140px" HorizontalAlign="Center" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Leave Days">
                                <FooterTemplate>
                                    <asp:Label ID="lblTotLvDays" runat="server" Text=""></asp:Label>
                                </FooterTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblLvDays" runat="server" Text='<%# Bind("LvDetDays") %>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Status">
                                <ItemTemplate>
                                    <asp:Label ID="lblStatus" runat="server" Text='<%# Bind("LvDetAppFlag") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField ShowHeader="False" Visible="False">
                                <ItemTemplate>
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="txtLvFrmDt" EventName="TextChanged" />
            <asp:AsyncPostBackTrigger ControlID="txtLvToDt" EventName="TextChanged" />
