<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="frmLoadSlipTallyUpdt.aspx.cs" Inherits="DRN_WEB_ERP.Module.Transport.Forms.frmLoadSlipTallyUpdt" %>
            ...
            <div>
               ...
               <div align="center">
                ...
                <div align="center">
                    <asp:Panel ID="pnlTallyHdr" runat="server" CssClass="cpHeader" Width="600px">
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td align="right">
                                    <asp:Image ID="imgTally" CssClass="imgBtn" runat="server" ImageUrl="~/Image/collapse.jpg">
                                    </asp:Image>
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
                    <asp:Panel ID="pnlTallyDet" runat="server" CssClass="cpBody" Width="600px" Height="55px">
                        <table>
                            <tr>
                                <td>
                                    Item Name:
                                ...
                                <td>
                                    <asp:TextBox ID="txtTallyItemName" runat="server" autoComplete="off" Width="250px"
                                        CssClass="search textAlignCenter" Enabled="False"></asp:TextBox>
                                    <cc1:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" BehaviorID="AutoCompleteDoItemName"
                                        ...
                                        ShowOnlyCurrentWordInCompletionListItem="true" TargetControlID="txtTallyItemName">
                                    </cc1:AutoCompleteExtender>
                                </td>
                                <td>
                                    &nbsp;
                                ...
                                <td>
                                    <asp:TextBox ID="txtTallyQty" runat="server" CssClass="textAlignCenter" ValidationGroup="TallyGrp"
                                        Width="100px" Enabled="False"></asp:TextBox>
                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender5" runat="server" Enabled="True"
                                        FilterMode="ValidChars" FilterType="Numbers, Custom" TargetControlID="txtTallyQty"
                                        ValidChars=".">
                                    </cc1:FilteredTextBoxExtender>
                                </td>
                                <td>
                                    <asp:Button ID="btnUpdateTally" runat="server" Text="Update" ValidationGroup="TallyGrp"
                                        Visible="true" Width="60px" OnClick="btnUpdateTally_Click" Enabled="False" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:CustomValidator ID="CustomValidator1" runat="server" ControlToValidate="txtTallyItemName"
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtTallyItemName"
                                        ErrorMessage="Enter Item Name" ForeColor="Red" ValidationGroup="TallyGrp"></asp:RequiredFieldValidator>
                                </td>
                                <td>
                                    &nbsp;
                                </td>
                    ...
                    <cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtender2" runat="server" TargetControlID="pnlTallyDet"
                        CollapseControlID="pnlTallyHdr" ExpandControlID="pnlTallyHdr" Collapsed="false"
                        TextLabelID="lblTallyHdr" CollapsedText="Tally Section" ExpandedText="Tally Section"
                        CollapsedSize="0" ExpandedSize="55" AutoCollapse="False" AutoExpand="False" ScrollContents="false"
                        ImageControlID="imgTally" ExpandedImage="~/Image/collapse.jpg" CollapsedImage="~/Image/expand.jpg"
                        ExpandDirection="Vertical">
                    </cc1:CollapsiblePanelExtender>
                </div>
