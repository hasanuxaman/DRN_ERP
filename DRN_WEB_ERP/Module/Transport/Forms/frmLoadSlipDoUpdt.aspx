<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="frmLoadSlipDoUpdt.aspx.cs" Inherits="DRN_WEB_ERP.Module.Transport.Forms.frmLoadSlipDoUpdt" %>
        ...
        <ContentTemplate>
            ...
            <div>
                ...
                <div align="center">
                    ...
                    <cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtender2" runat="server" TargetControlID="pnlLsDet"
                ...
                <div align="center">
                    <asp:Panel ID="pnlDoHdr" runat="server" CssClass="cpHeader" Width="600px">
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td align="right">
                                    <asp:Image ID="imgDo" CssClass="imgBtn" runat="server" ImageUrl="~/Image/collapse.jpg">
                                    </asp:Image>
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
                    <asp:Panel ID="pnlDoDet" runat="server" CssClass="cpBody" Width="600px" Height="175px">
                        <table>
                            <tr>
                                <td align="left">
                                    Dealer Name
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtDealerName" runat="server" Width="280px" autoComplete="off" CssClass="textAlignCenter search"
                                    ...
                                    <cc1:AutoCompleteExtender ID="AutoCompleteExtendeDealer" runat="server" BehaviorID="AutoCompleteDealer"
                                        ...
                                        ServiceMethod="GetSrchActiveCustomer" ServicePath="~/Module/Sales/Forms/wsAutoComSales.asmx"
                                        ShowOnlyCurrentWordInCompletionListItem="true" TargetControlID="txtDealerName">
                                    </cc1:AutoCompleteExtender>
                                </td>
                                <td>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtDealerName"
                                        ErrorMessage="Enter Dealer Name" ForeColor="Red" ValidationGroup="DoGrp">*</asp:RequiredFieldValidator>
                                    <asp:CustomValidator ID="CustomValidator1" runat="server" ControlToValidate="txtDealerName"
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtItemName" runat="server" Width="280px" autoComplete="off" CssClass="textAlignCenter search"
                                        Enabled="False"></asp:TextBox>
                                    <cc1:AutoCompleteExtender ID="AutoCompleteExtenderDoItemName" runat="server" BehaviorID="AutoCompleteDoItemName"
                                        CompletionInterval="100" CompletionListCssClass="autocomplete_completionListElement"
                                        CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem" CompletionListItemCssClass="autocomplete_listItem"
                                        CompletionSetCount="20" DelimiterCharacters="," EnableCaching="true" MinimumPrefixLength="1"
                                        ServiceMethod="GetSrchActiveFilteredItem" ServicePath="~/Module/Inventory/Forms/wsAutoCompInv.asmx"
                                ...
                                <td>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtItemName"
                                        ErrorMessage="Enter Item Name" ForeColor="Red" ValidationGroup="DoGrp">*</asp:RequiredFieldValidator>
                                    <asp:CustomValidator ID="CustomValidator2" runat="server" ControlToValidate="txtItemName"
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtBagType" runat="server" Width="280px" autoComplete="off" CssClass="textAlignCenter search"
                                        Enabled="False"></asp:TextBox>
                                    <cc1:AutoCompleteExtender ID="AutoCompleteExtenderDoBagType" runat="server" BehaviorID="AutoCompleteDoBagType"
                                        CompletionInterval="100" CompletionListCssClass="autocomplete_completionListElement"
                                        CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem" CompletionListItemCssClass="autocomplete_listItem"
                                        CompletionSetCount="20" DelimiterCharacters="," EnableCaching="true" MinimumPrefixLength="1"
                                        ServiceMethod="GetSrchActiveFilteredItem" ServicePath="~/Module/Inventory/Forms/wsAutoCompInv.asmx"
                                        ShowOnlyCurrentWordInCompletionListItem="true" TargetControlID="txtBagType">
                                    </cc1:AutoCompleteExtender>
                                </td>
                                <td>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtBagType"
                                        ErrorMessage="Enter Bag Type" ForeColor="Red" ValidationGroup="DoGrp">*</asp:RequiredFieldValidator>
                                    <asp:CustomValidator ID="CustomValidator3" runat="server" ControlToValidate="txtBagType"
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtQty" runat="server" Width="297px" CssClass="textAlignCenter"
                                        Enabled="False"></asp:TextBox>
                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" Enabled="True"
                                        FilterMode="ValidChars" FilterType="Numbers, Custom" TargetControlID="txtQty"
                                        ValidChars=".">
                                    </cc1:FilteredTextBoxExtender>
                                </td>
                                <td>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtQty"
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtChallanNo" runat="server" Width="280px" CssClass="search textAlignCenter"
                                        Enabled="False"></asp:TextBox>
                                    <cc1:AutoCompleteExtender ID="AutoCompleteExtenderSrchChln" runat="server" BehaviorID="AutoCompleteChln"
                                        CompletionInterval="100" CompletionListCssClass="autocomplete_completionListElement"
                                        CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem" CompletionListItemCssClass="autocomplete_listItem"
                                        CompletionSetCount="20" DelimiterCharacters="," EnableCaching="true" MinimumPrefixLength="3"
                                        ServiceMethod="GetSrchUndeliverChlnList" ServicePath="~/Module/Sales/Forms/wsAutoComSales.asmx"
                                        ShowOnlyCurrentWordInCompletionListItem="true" TargetControlID="txtChallanNo">
                                    </cc1:AutoCompleteExtender>
                                </td>
                                <td>
                                    <asp:CustomValidator ID="CustomValidator4" runat="server" ControlToValidate="txtChallanNo"
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <asp:Button ID="btnUpdateDo" runat="server" Text="Update" ValidationGroup="DoGrp"
                                        Visible="true" Width="60px" OnClick="btnUpdateDo_Click" Enabled="False" />
                                </td>
                                <td>
                                    &nbsp;
                                </td>
                    ...
                    <cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtender1" runat="server" TargetControlID="pnlDoDet"
                        CollapseControlID="pnlDoHdr" ExpandControlID="pnlDoHdr" Collapsed="false" TextLabelID="lblDoHdr"
                        CollapsedText="D/O Section" ExpandedText="D/O Section" CollapsedSize="0" ExpandedSize="175"
                        AutoCollapse="False" AutoExpand="False" ScrollContents="false" ImageControlID="imgDo"
                        ExpandedImage="~/Image/collapse.jpg" CollapsedImage="~/Image/expand.jpg" ExpandDirection="Vertical">
                    </cc1:CollapsiblePanelExtender>
                </div>
