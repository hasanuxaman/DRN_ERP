<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="frmLoadSlipVatUpdt.aspx.cs" Inherits="DRN_WEB_ERP.Module.Transport.Forms.frmLoadSlipVatUpdt" %>
                    ...
                    <asp:Panel ID="pnlVatHdr" runat="server" CssClass="cpHeader" Width="600px">
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td align="right">
                                    <asp:Image ID="imgVat" CssClass="imgBtn" runat="server" ImageUrl="~/Image/collapse.jpg">
                                    </asp:Image>
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
                    <asp:Panel ID="pnlVatDet" runat="server" CssClass="cpBody" Width="600px" Height="35px">
                        <table>
                            <tr>
                                <td>
                                    &nbsp;
                                ...
                                <td>
                                    <asp:Button ID="btnUpdtVat" runat="server" Text="VAT Challan Update" Visible="true"
                                        Enabled="False" OnClick="btnUpdtVat_Click" />
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
                    <cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtenderWgtScale" runat="server"
                        TargetControlID="pnlVatDet" CollapseControlID="pnlVatHdr" ExpandControlID="pnlVatHdr"
                        Collapsed="false" TextLabelID="lblVatHdr" CollapsedText="VAT Section" ExpandedText="VAT Section"
                        CollapsedSize="0" ExpandedSize="35" AutoCollapse="False" AutoExpand="False" ScrollContents="false"
                        ImageControlID="imgVat" ExpandedImage="~/Image/collapse.jpg" CollapsedImage="~/Image/expand.jpg"
                        ExpandDirection="Vertical">
                    </cc1:CollapsiblePanelExtender>
                </div>
