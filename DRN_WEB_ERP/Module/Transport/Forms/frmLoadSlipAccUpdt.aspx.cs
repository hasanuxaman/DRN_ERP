...
{
    public partial class frmLoadSlipAccUpdt : System.Web.UI.Page
    {
        ...
        protected void GetLoadSlipData()
        {
            ...
            if (dtLS.Rows.Count > 0)
            {
                ...
                txtAccGiftItem.Text = dtLS[0].LS_DISP_Gift_Item_Name.ToString();
                txtAccGiftItemQty.Text = dtLS[0].LS_Ext_Data1.ToString();
                txtAccAdvAmt.Text = Convert.ToInt32(dtLS[0].LS_DISP_Adv_Amt) > 0 ? dtLS[0].LS_DISP_Adv_Amt.ToString() : "";
                txtAccFuelQty.Text = Convert.ToInt32(dtLS[0].LS_DISP_Fuel_Qty) > 0 ? dtLS[0].LS_DISP_Fuel_Qty.ToString() : "";

                //if (!dtLS[0].IsLS_DISP_Updt_TimeNull() && dtLS[0].IsLS_ACC_Updt_TimeNull())
                //{
                //    txtAccGiftItem.Enabled = true;
                //    txtAccGiftItemQty.Enabled = true;
                //    txtAccAdvAmt.Enabled = true;
                //    txtAccFuelQty.Enabled = true;
                //}
                //else
                //{
                //    txtAccGiftItem.Enabled = false;
                //    txtAccGiftItemQty.Enabled = false;
                //    txtAccAdvAmt.Enabled = false;
                //    txtAccFuelQty.Enabled = false;
                //}
        ...
        protected void btnUpdateAcc_Click(object sender, EventArgs e)
        {
            ...
            taLs.UpdateLsAcc("OK", DateTime.Now, "", hfLsRefNo.Value.ToString());
