<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="frmLoadSlipAccUpdt.aspx.cs" Inherits="DRN_WEB_ERP.Module.Transport.Forms.frmLoadSlipAccUpdt" %>
            ...
            <div>
                ...
                <div align="center">
                    <asp:Panel ID="pnlAccHdr" runat="server" CssClass="cpHeader" Width="600px">
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td align="right">
                                    <asp:Image ID="imgAcc" CssClass="imgBtn" runat="server" ImageUrl="~/Image/collapse.jpg">
                                    </asp:Image>
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
                    <asp:Panel ID="pnlAccDet" runat="server" CssClass="cpBody" Width="600px" Height="65px">
                        <table>
                            <tr>
                                ...
                                <td colspan="5" align="left">
                                    <asp:TextBox ID="txtAccGiftItem" runat="server" autoComplete="off" Width="296px"
                                    ...
                                    <cc1:AutoCompleteExtender ID="AutoCompleteExtenderGiftItemName" runat="server" BehaviorID="AutoCompleteGiftItemName"
                                        ...
                                        ShowOnlyCurrentWordInCompletionListItem="true" TargetControlID="txtAccGiftItem">
                                    </cc1:AutoCompleteExtender>
                                </td>
                                ...
                                <td width="156" align="left">
                                    &nbsp;
                                    <asp:TextBox ID="txtAccGiftItemQty" runat="server" CssClass="textAlignCenter" ValidationGroup="DispatchGrp"
                                        Width="84px" Enabled="False"></asp:TextBox>
                                    <cc1:FilteredTextBoxExtender ID="txtAccGiftItemQty_FilteredTextBoxExtender" runat="server"
                                        Enabled="True" FilterMode="ValidChars" FilterType="Numbers, Custom" TargetControlID="txtAccGiftItemQty"
                                        ValidChars=".">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtAccAdvAmt" runat="server" CssClass="textAlignCenter" ValidationGroup="DispatchGrp"
                                        Width="90px" Enabled="False"></asp:TextBox>
                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender9" runat="server" Enabled="True"
                                        FilterMode="ValidChars" FilterType="Numbers, Custom" TargetControlID="txtAccAdvAmt"
                                        ValidChars=".">
                                    </cc1:FilteredTextBoxExtender>
                                </td>
                                <td>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtAccFuelQty" runat="server" CssClass="textAlignCenter" ValidationGroup="DispatchGrp"
                                        Width="95px" Enabled="False"></asp:TextBox>
                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender7" runat="server" Enabled="True"
                                        FilterMode="ValidChars" FilterType="Numbers, Custom" TargetControlID="txtAccFuelQty"
                                        ValidChars=".">
                                    </cc1:FilteredTextBoxExtender>
                                </td>
                                <td style="width: 112px">
                                ...
                                <td align="center" width="156">
                                    &nbsp;
                                    <asp:Button ID="btnUpdateAcc" runat="server" Text="Update" ValidationGroup="DispatchGrp"
                                        Visible="true" Width="60px" Enabled="False" OnClick="btnUpdateAcc_Click" />
                                </td>
                                <td width="156">
                                    &nbsp;
                                </td>
                    ...
                    <cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtenderWgtScale" runat="server"
                        TargetControlID="pnlAccDet" CollapseControlID="pnlAccHdr" ExpandControlID="pnlAccHdr"
                        Collapsed="false" TextLabelID="lblAccHdr" CollapsedText="Accounts Section" ExpandedText="Accounts Section"
                        CollapsedSize="0" ExpandedSize="65" AutoCollapse="False" AutoExpand="False" ScrollContents="false"
                        ImageControlID="imgAcc" ExpandedImage="~/Image/collapse.jpg" CollapsedImage="~/Image/expand.jpg"
                        ExpandDirection="Vertical">
                    </cc1:CollapsiblePanelExtender>
                </div>
