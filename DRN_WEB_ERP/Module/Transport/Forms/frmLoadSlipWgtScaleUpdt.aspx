<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="frmLoadSlipWgtScaleUpdt.aspx.cs" Inherits="DRN_WEB_ERP.Module.Transport.Forms.frmLoadSlipWgtScaleUpdt" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="updpnl" runat="server" UpdateMode="Conditional">
            ...
            <div>
                ...
                <div align="center">
                    <asp:Panel ID="pnlWgtScaleHdr" runat="server" CssClass="cpHeader" Width="600px">
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td align="right">
                                    <asp:Image ID="imgWgtScale" CssClass="imgBtn" runat="server" ImageUrl="~/Image/collapse.jpg">
                                    </asp:Image>
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
                    <asp:Panel ID="pnlWgtScaleDet" runat="server" CssClass="cpBody" Width="600px" Height="60px">
                        <table>
                            <tr>
                                <td>
                                    &nbsp;
                                ...
                                <td>
                                    <asp:TextBox ID="txtEmptyWgt" runat="server" autoComplete="off" Width="100px" CssClass="textAlignCenter"
                                        Font-Size="9pt" Enabled="False"></asp:TextBox>
                                ...
                                <td>
                                    <asp:TextBox ID="txtLoadWgt" runat="server" ValidationGroup="WgtScaleGrp" Width="100px"
                                        CssClass="textAlignCenter" Font-Size="9pt" Enabled="False"></asp:TextBox>
                                ...
                                <td>
                                    <asp:Button ID="btnUpdateWgtScale" runat="server" Text="Update" ValidationGroup="WgtScaleGrp"
                                        Visible="true" Width="60px" OnClick="btnUpdateWgtScale_Click" Enabled="False" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td align="left" colspan="3">
                                    <asp:CustomValidator ID="CustomValidator2" runat="server" ControlToValidate="txtEmptyWgt"
                                        ErrorMessage="Enter Loaded Truck Weight" Font-Size="8pt" ForeColor="Red" OnServerValidate="CustomValidator2_ServerValidate"
                                        ValidationGroup="WgtScaleGrp" ValidateEmptyText="True"></asp:CustomValidator>
                                </td>
                                <td>
                                    &nbsp;
                                </td>
                                <td align="left" colspan="3">
                                    <asp:CustomValidator ID="CustomValidator1" runat="server" ControlToValidate="txtLoadWgt"
                                        ErrorMessage="Enter Loaded Truck Weight" Font-Size="8pt" ForeColor="Red" OnServerValidate="CustomValidator1_ServerValidate"
                                        ValidationGroup="WgtScaleGrp" ValidateEmptyText="True"></asp:CustomValidator>
                                </td>
                                <td>
                                    &nbsp;
                    ...
                    <cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtenderWgtScale" runat="server"
                        ...
                        Collapsed="false" TextLabelID="lblWgtScaleHdr" CollapsedText="Weight Scale Section"
                        ExpandedText="Weight Scale Section" CollapsedSize="0" ExpandedSize="60" AutoCollapse="False"
                        AutoExpand="False" ScrollContents="false" ImageControlID="imgWgtScale" ExpandedImage="~/Image/collapse.jpg"
                        CollapsedImage="~/Image/expand.jpg" ExpandDirection="Vertical">
                    </cc1:CollapsiblePanelExtender>
                </div>
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="btnUpdateWgtScale" EventName="Click" />
        </Triggers>
    </asp:UpdatePanel>
